...
class SongbirdImpl:
    ...
    def move_to(self, channel: discord.abc.Snowflake) -> typing.Coroutine[typing.Any, typing.Any, None]:
        ...
        None
        """
    def listen(self, sink: receive.SinkBase) -> None:
        r"""
        |coro|
        ...
        ```
        """
    def play(self, track: player.Track) -> typing.Coroutine[typing.Any, typing.Any, player.TrackHandle]:
        r"""
        |coro|
    ...
    def queue(self) -> player.Queue:
        ...
        Queue
        """
    def enqueue(self, track: player.Track) -> typing.Coroutine[typing.Any, typing.Any, player.TrackHandle]:
        r"""
        |coro|
